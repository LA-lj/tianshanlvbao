...
def main(meta_instruction):
    ...
    # 页面标题
    st.title("天山绿宝-新疆农产品销售平台⭐🛒🏆")

    # 说明
    st.info(
        "本项目是基于人工智能的文字、语音、视频生成领域搭建的新疆农产品销售平台。用户被授予使用此工具创建文字、语音、视频的自由，但用户在使用过程中应该遵守当地法律，并负责任地使用。开发人员不对用户可能的不当使用承担任何责任。",
        icon="❗",
    )
