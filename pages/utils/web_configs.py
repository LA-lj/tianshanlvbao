...
class WebConfigs:
    ...
    #                               页面配置
    # ==================================================================
    PRODUCT_IMAGE_HEIGHT: int = 700  # 商品图片高度
    EACH_CARD_OFFSET: int = 50  # 每个商品卡片比图片高度多出的距离
    ...
    TTS_MODEL_DIR: str = r"/group_share/Streamer-Sales/weights/gpt_sovits_weights"
    ...
    DIGITAL_HUMAN_VIDEO_PATH: str = r"/group_share/Streamer-Sales/doc/digital_human/jiangguohuiban2.mp4"
